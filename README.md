...
Раньше работал в графическом дизайне, мне нравилось решать сложные задачи: разрабатывать проекты с дополнительной реальностью (AR) или новые технологии для вырезки на хромакее.

В тот момент я понял, что для полноценной разработки нужны знания языков программирования и решил, что пора перейти в IT сферу, — меня захватывает процесс разработки и возможность создавать удобные и полезные продукты.

Я защитил диплом [Веб-разработчика](https://practicum.yandex.ru/web/) в Яндекс Практикуме. Ежедневно практикуюсь в программировании, пишу pet-проекты в портфолио и изучаю курсы по алгоритмам и фреймворкам (React, Vue, Angular).
